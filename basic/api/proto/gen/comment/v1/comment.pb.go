...
const file_comment_v1_comment_proto_rawDesc = "" +
	...
	"\x0eGetMoreReplies\x12!.comment.v1.GetMoreRepliesRequest\x1a\".comment.v1.GetMoreRepliesResponseB\x91\x01\n" +
	"\x0ecom.comment.v1B\fCommentProtoP\x01Z(basic/api/proto/gen/comment/v1;commentv1\xa2\x02\x03CXX\xaa\x02\n" +
	"Comment.V1\xca\x02\n" +
