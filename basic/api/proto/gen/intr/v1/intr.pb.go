...
const file_intr_v1_intr_proto_rawDesc = "" +
	...
	"\tcollected\x18\a \x01(\bR\tcollected\"K\n" +
	...
	"\bGetByIds\x12\x18.intr.v1.GetByIdsRequest\x1a\x19.intr.v1.GetByIdsResponseBy\n" +
	"\vcom.intr.v1B\tIntrProtoP\x01Z\"basic/api/proto/gen/intr/v1;intrv1\xa2\x02\x03IXX\xaa\x02\aIntr.V1\xca\x02\aIntr\\V1\xe2\x02\x13Intr\\V1\\GPBMetadata\xea\x02\bIntr::V1b\x06proto3"
...
var file_intr_v1_intr_proto_goTypes = []any{
	...
	(*CancelCollectRequest)(nil),  // 9: intr.v1.CancelCollectRequest
	(*CancelCollectResponse)(nil), // 10: intr.v1.CancelCollectResponse
...
var file_intr_v1_intr_proto_depIdxs = []int32{
	...
	9,  // 7: intr.v1.InteractiveService.CancelCollect:input_type -> intr.v1.CancelCollectRequest
	...
	8,  // 12: intr.v1.InteractiveService.CancelLike:output_type -> intr.v1.CancelLikeResponse
	6,  // 13: intr.v1.InteractiveService.Collect:output_type -> intr.v1.CollectResponse
	10, // 14: intr.v1.InteractiveService.CancelCollect:output_type -> intr.v1.CancelCollectResponse
