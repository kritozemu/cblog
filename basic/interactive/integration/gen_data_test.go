...
import (
	...
	"compus_blog/basic/internal/integration/startup"
	_ "embed"
...
// 使用操作
//cd basic/interactive/integration
//
//go test -run TestGenSQL -v
//
//Get-Content .\data.sql -Raw | mysql -h localhost -P 13316 -uroot -p123 cblog
