...
type InteractiveService interface {
	...
	Collect(ctx context.Context, biz string, id, uid, cid int64) error
...
func (svc *InteractiveServiceStruct) Collect(ctx context.Context, biz string, id, uid, cid int64) error {
	return svc.repo.AddCollectionItem(ctx, biz, id, uid, cid)
}
